...
namespace Projects.Query.Api.Controllers
{
    ...
    public class ProjectPriorityLookupController : ControllerBase
    {
        ...
        private readonly IQueryDispatcher<ProjectPriorityEnum> _queryDispatcher;

        public ProjectPriorityLookupController(ILogger<ProjectPriorityLookupController> logger, IQueryDispatcher<ProjectPriorityEnum> queryDispatcher)
        {
            _logger = logger;
        ...
        private ActionResult NormalResponse(List<ProjectPriorityEnum> projectTypes)
        {
